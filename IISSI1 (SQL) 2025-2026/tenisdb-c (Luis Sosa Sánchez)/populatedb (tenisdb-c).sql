...
BEGIN
    ...
    INSERT INTO people (person_id, `name`, age, nationality) VALUES
        ...
        -- creo los nuevos entrenadores 
        (19, 'Harry Potter', 45, 'Reino Unido'),
        (20, 'Hermione Granger', 46, 'Reino Unido'),
        (21, 'Ron Weasley', 45, 'Reino Unido'),
        (22, 'Draco Malfoy', 45, 'Reino Unido'),
        (23, 'Lord Voldemort', 99, 'Reino Unido');
    ...
    INSERT INTO referees (referee_id, license) VALUES 
	 ...
	 -- Entrenadores (comienzo por el 19 ya que así no coincide con que ningún entrenador juegue ningún partido) 
    ...
    -- Jugadores
    INSERT INTO players (player_id, trainer_id, ranking, activo) VALUES 
        (1, 19, 1, TRUE),
        (2, 20, 2, TRUE),
        (3, 19, 4, TRUE),
        (4, 20, 5, TRUE),
        ...
        -- entrenadores que antes eran jugadores (ya no están activos), pongo rankings muy lejanos para no interferir 
        (19, NULL, 900, FALSE),
        (20, NULL, 902, FALSE),
        (21, NULL, 904, FALSE),
        (22, NULL, 903, FALSE),
