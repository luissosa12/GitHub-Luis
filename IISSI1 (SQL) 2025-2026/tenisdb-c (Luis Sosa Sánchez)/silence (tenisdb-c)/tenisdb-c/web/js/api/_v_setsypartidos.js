...
const v_setsypartidosAPI_auto = {

    /** Gets all entries from 'v_setsypartidos' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/v_setsypartidos`, requestOptions);
        return response.data;
    },
};

export { v_setsypartidosAPI_auto };