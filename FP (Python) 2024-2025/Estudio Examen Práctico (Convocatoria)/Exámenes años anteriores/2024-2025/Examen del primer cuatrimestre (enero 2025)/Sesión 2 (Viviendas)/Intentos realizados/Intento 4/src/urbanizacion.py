...
def n_viviendas_top_valoradas_por_calle(viviendas: List[Vivienda], fecha: date | None = None, n: int = 3) -> Dict[str, List[Tuple[str,int,int]]]: 
    ...
    for calle, valores in res.items():
        lista_ordenada = sorted(valores, key=lambda x:x[2], reverse=True)[:n]
...
#---------------------------------------------------------------------------------------------------------------------------------------------
#OTRA FORMA: 
def n_viviendas_top_valoradas_por_calle2(viviendas: List[Vivienda], fecha: date | None = None, n: int = 3) -> Dict[str, List[Tuple[str, int, int]]]:
