...
print()
print(f"Aquí se imprimen las 2 primeras: {viviendas[:2]}")

#---------------------------------------------------------------------------------------------------------------------------------------------
#TEST DEL EJERCICIO 2: 
print()
print("TEST DEL EJERCICIO 2: ===============================================================================================================")
mejoras1 = total_mejoras_por_calle(viviendas, "par")
print(f"Número de mejoras en viviendas con número ('par'): {mejoras1}")

mejoras2 = total_mejoras_por_calle(viviendas, "impar")
print(f"Número de mejoras en viviendas con número ('impar'): {mejoras2}")
...
diferencia_precios = calle_mayor_diferencia_precios(viviendas)
print(f"La calle con una mayor diferencia de precios entre los números pares e impares es: {diferencia_precios}")
