...
print(f"Se han leído: {len(viviendas)} viviendas")
print(f"Aquí se muestran las 3 primeras: {viviendas[:2]}")

#---------------------------------------------------------------------------------------------------------------------------------------------
#TEST DEL EJERCICIO 2: 
print()
print("TEST DEL EJERCICIO 2: ===============================================================================================================")
par = total_mejoras_por_calle(viviendas, "par")
print(f"Número de mejoras en viviendas con número ('par'): {par}")

impar = total_mejoras_por_calle(viviendas, "impar")
print(f"Número de mejoras en viviendas con número ('impar'): {impar}")
