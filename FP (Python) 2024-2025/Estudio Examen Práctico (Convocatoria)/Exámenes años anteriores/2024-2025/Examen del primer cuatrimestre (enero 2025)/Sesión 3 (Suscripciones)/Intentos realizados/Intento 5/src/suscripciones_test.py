...
print(f"Hay un total de: {len(suscripciones)} suscripciones")
print()
...
dias_plan = media_dias_por_plan(suscripciones)
print(f"La duración media (en días) de las suscripciones finalizadas por tipo de plan son: {dias_plan}")

#---------------------------------------------------------------------------------------------------------------------------------------------
#TEST DEL EJERCICIO 5: 
print()
print("TEST DEL EJERCICIO 5: ===============================================================================================================")
mas_veces = addon_mas_popular_por_año(suscripciones)
print(f"Addons que mas veces aparece por año: {mas_veces}")
