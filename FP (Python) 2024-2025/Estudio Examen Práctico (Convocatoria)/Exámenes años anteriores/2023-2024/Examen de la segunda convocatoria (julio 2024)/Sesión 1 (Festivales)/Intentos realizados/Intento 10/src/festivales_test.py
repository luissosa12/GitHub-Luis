...
print()
print(f"Aquí se muestran los 2 primeros: {festivales[:2]}")
...
mas_veces = artista_top(festivales)
print(f"El artista que ha actuado en más festivales es: {mas_veces[1]}, con un total de: {mas_veces[0]} festivales")
...
print(f"El mes de mayor beneficio es: {mayor_beneficio}")
