...
mes_mayor_beneficio = mes_mayor_beneficio_medio(festivales)
print(f"El mes con más beneficio es: {mes_mayor_beneficio}")
...
print(f"Los artistas comunes entre Iconica Fest y Primavera Sound: {comunes3}")
...
print(f"Los mejores 1 festivales por número de días son: {top_festivales1}")

top_festivales2 = festivales_top_calidad_por_duracion(festivales, 3)
print(f"Los mejores 3 festivales por número de días son: {top_festivales2}")
