...
def festivales_top_calidad_por_duracion(festivales: List[Festival], n: int=3) -> Dict[int, List[str]]: 
    ...
    for f in festivales:
        ...
        res1[duracion].append((f.nombre, calidad))

    res2 = dict()
    for duracion, nombre_calidad in res1.items():
