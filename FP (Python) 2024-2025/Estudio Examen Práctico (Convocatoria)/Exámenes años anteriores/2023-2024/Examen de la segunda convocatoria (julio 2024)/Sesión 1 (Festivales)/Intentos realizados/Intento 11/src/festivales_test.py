...
print()
print(f"Aquí se muestran los 3 primeros: {festivales[:3]}")
...
top_artista = artista_top(festivales)
print(f"El artista que ha actuado en más festivales es: {top_artista[1]}, con un total de: {top_artista[0]} festivales")
...
mayor_beneficio = mes_mayor_beneficio_medio(festivales)
print(f"El mes con un mayor beneficio medio es: {mayor_beneficio}")
...
top_calidad1 = festivales_top_calidad_por_duracion(festivales, 1)
print(f"Los mejores 1 festivales por número de días son: {top_calidad1}")

top_calidad2 = festivales_top_calidad_por_duracion(festivales, 3)
print(f"Los mejores 3 festivales por número de días son: {top_calidad2}")
