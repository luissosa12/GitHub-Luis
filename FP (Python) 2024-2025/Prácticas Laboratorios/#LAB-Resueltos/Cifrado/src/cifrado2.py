...
def rompe_codigo_cifrado(texto, vocabulario):
    ...
    '''
    posible_desplazamiento = range(len(string.ascii_lowercase))
    aciertos = {i:cuenta_palabras_validas(descifra_mensaje(texto, i), vocabulario) for i in posible_desplazamiento}
