...
def ingredientes_en_unidad(lista_recetas: list[Receta], unidad: Optional[str]) -> int:
    res = set()
...
#-------------------------------------------------------------------------------------------------------------------------
#   EJERCICIO 4:
def recetas_con_ingredientes(lista_recetas: list[Receta], nombre_ingredientes: set[str]) -> list[tuple[str, int, float]]:
    res = set()
    for r in lista_recetas:
        for i in r.ingredientes:
            if i.nombre in nombre_ingredientes:
