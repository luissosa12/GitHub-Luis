...
def lee_compras(ruta_fichero: str) -> list[Compra]:
    ...
    with open(ruta_fichero, 'r', encoding='utf-8') as f:
        ...
        for dni, supermercado, provincia, fecha_llegada, fecha_salida, total_compra in lector:
            ...
            res.append(tupla)
    return res
#.split() -> para parsear cadenas de texto en subcadenas; dentro del paréntesis se escribe lo que separe a las cadenas entre comillas y un espacio si es que lo hay en la cadena principal; Ej. de uso:
