...
def test_lee_compras(compras: list[Compra]) -> None:
    ...
    print()
    print('TEST DE LA FUNCIÓN 1: Probando la función: test_lee_compras:...')
...
def test_hora_menos_afluencia(compras: list[Compra]) -> None:
    ...
    print(f'La hora de menos afluencia fueron las: {sol[0]}h, con un total de: {sol[1]} personas')
    print()
#-------------------------------------------------------------------------------------------------------------------------
...
def test_supermercados_mas_facturacion(compras: list[Compra], n: int = 3) -> None:
    ...
    print(f'Los {n} supermercados con más facturación por orden decreciente son: {sol}')
    print()
#-------------------------------------------------------------------------------------------------------------------------
...
def test_clientes_itinerantes(compras: list[Compra], n: int) -> None:
    ...
    print(f'Los clientes que han visitado más  de {n} provincias son: {sol}')
    print()
#-------------------------------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------
if __name__ == '__main__':
    compras = lee_compras('data\compras.csv')
    #LLAMADA AL TEST DE LA FUNCIÓN 1:
